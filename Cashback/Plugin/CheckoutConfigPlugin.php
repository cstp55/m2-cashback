<?php
namespace Aprilo\Cashback\Plugin;

use Aprilo\Cashback\Helper\Data as Helper;
...
class CheckoutConfigPlugin
{
    ...
    public function afterGetConfig(
        ...
        $result['Aprilo']['hasMpGiftCard'] = $this->checkMpGiftCardInCart();
        $result['Aprilo']['cashback'] = $this->getCashbackConfig();
        return $result;
    }
