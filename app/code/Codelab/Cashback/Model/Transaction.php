...
use Codelab\Cashback\Model\Cashback\Action as CashbackAction;
...
class Transaction extends AbstractModel implements IdentityInterface
{
     ...
     * Cache
     */
    const CACHE_TAG = 'codelab_cashback_transaction';
    ...
    public function __construct(
        Context $context,
        Registry $registry,
        \Codelab\Cashback\Model\CreditFactory $creditFactory,
    ...
    {
        parent::_construct();
        $this->_init(\Codelab\Cashback\Model\ResourceModel\Transaction::class);
    }
    ...
    public function getTransactionsForCustomer($customerId)
    {
        ...
        $transactions->getSelect()
            ->join(
                ['cr' => $transactions->getTable('codelab_cashback_credit')],
